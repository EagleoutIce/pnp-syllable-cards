...
\shadowbox[text width=.85*\CardEffectiveWidth,inner sep=\z@,align=center,text=white,minimum height=4.5\baselineskip,font=\Fontauri\small] at (.5*\CardWidth,-.7*\CardHeight) {\get{spec}};
